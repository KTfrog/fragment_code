...
void client_read_net_data(int sockfd) 
{
    PRINT("func:%s, line:%d. \n", __func__, __LINE__);
    ssize_t nread;
...
int main(int argc, char** argv)
{
    ...
    lsquic_engine_connect(engine, LSQVER_I001, (struct sockaddr *) &local_addr, (struct sockaddr *) &peer_addr, (void *) &sockfd, 
    ...
    do {
        ...
        // if (g_cl_client_ctx->stream_h && g_cl_client_ctx->stream_h->stream) {
        //     break;
        // }
        count--;
    } while(count>0);
